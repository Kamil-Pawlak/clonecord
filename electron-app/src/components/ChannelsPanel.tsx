...
const ChannelsPanel = (props: Props) => {
  ...
  return (
    <div className="w-64 bg-gray-800 h-full border-gray-500 border-1 text-white flex flex-col gap-0.5">
      ...
      items-center cursor-pointer hover:bg-gray-700/50" id='server-header'  onClick={(e) => { setDropdownOpen(!dropdownOpen); }}>
      ...
      <div className='relative' ref={ref} >
        <DropMeDown open={dropdownOpen} options={[
          ...
          { label: 'Create Channel', onClick: () => console.log('Create Channel clicked') },
        ]} />
      </div>
